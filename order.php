						...
						<div class="row">
							...
							<div class="col-md-6"><!--Dividing in 6-->
								<table>
									...
									<tr><td colspan="2"><a href="#" style="float:right;margin-right:130px;" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#checkout_modal">Place Order</a></td></tr>
								</table>
							</div>
						</div>
					</div>
